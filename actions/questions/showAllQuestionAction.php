...
//Récupérer les questions par défaut sans recherche query recuperer tous!
$getAllQuestions = $bdd->query('SELECT id, id_auteur, titre, description, pseudo_auteur, date_publication FROM questions ORDER BY id DESC LIMIT 0,5'); //0.5 zehma pr recuperer 5 recherches max.
